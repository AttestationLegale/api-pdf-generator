Feature: PrintDossier

    Scenario: Print Dossier of organisation that has some documents
        ...
        When I print the dossier of the organisation 12

        Then I get a response with the status code 200

    Scenario: Do not print Dossier of organisation that has no documents
        ...
        When I print the dossier of the organisation 15
