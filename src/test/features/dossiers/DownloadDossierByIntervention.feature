Feature: DownloadDossierByIntervention

    Scenario: Download my dossier in a project
        ...
        When I download the dossier for the intervention 42 and with utcOffset 120

        Then I get a response with the status code 200

    Scenario: Do not download dossier of organisation that has no documents for the intervention
    ...
    Scenario: Download my subcontractor's dossier in a project
        ...
        When I download the dossier of subcontractor 14 of intervention 43 and with utcOffset 120
